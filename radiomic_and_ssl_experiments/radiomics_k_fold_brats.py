...
'brats_k_fold_barlow_one_stage_all'
'brats_k_fold_barlow_one_stage_no_percep'
'brats_k_fold_barlow_contr_mae'
'brats_k_fold_barlow_no_contr'
FILENAME = 'brats_k_fold_barlow_one_stage_all'
...
def evaluate_features(is_50=False):
    ...
    for idx in range(3):
        ...
        # specificity_ssl_comb, sensitivity_ssl_comb, auroc_value_comb = work_on_combined_features(train_ids=train_ids,
        #                                                                                          test_ids=test_ids,
        #                                                                                          idx=idx, is_50=is_50)
        ...
        specificity_ssl_comb_contr, sensitivity_ssl_comb_contr, auroc_value_ssl_comb_contr = work_on_contrast_combined_features(
            train_ids=train_ids, test_ids=test_ids, idx=idx, is_50=is_50)
    ...
    print("SSL Features")
    print(
        f"Average specificity {avg_specificity_ssl / 3} and sensitivity {avg_sensitivity_ssl / 3} roc: {avg_auroc_value_ssl / 3}")
    print("Combined Features")
    print(
        f"Average specificity {avg_specificity_comb / 3} and sensitivity {avg_sensitivity_comb / 3} roc: {avg_auroc_value_comb / 3}")
    ...
    return [avg_specificity / 3, avg_specificity_ssl / 3, avg_specificity_comb / 3], [avg_sensitivity / 3,
                                                                                      avg_sensitivity_ssl / 3,
                                                                                      avg_sensitivity_comb / 3]
