...
def main(args):
    ...
    dataset_whole = get_dataset(dataset_name="brats", mode='whole', args=args, transforms=train_transforms,
                                use_z_score=args.use_z_score)
    # Since we do not want any augmentation on the test set.
    dataset_whole_no_aug = get_dataset(dataset_name="brats", mode='whole', args=args, transforms=None,
                                       use_z_score=args.use_z_score)
